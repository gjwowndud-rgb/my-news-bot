...
def generate_report():
    try:
        ...
        # 요청하신 기존 최신 버전인 gemini-2.0-flash를 사용합니다.
        ...
        if not response.text:
            return "⚠️ AI 분석 내용 생성 실패. 쿼터가 초기화되었는지 확인하세요."
            
        return response.text

    except Exception as e:
        # 상세 에러 메시지를 포함하여 텔레그램으로 전송
